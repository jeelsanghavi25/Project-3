...
&nbsp&nbsp&nbsp <u><h1>Living Room</h1></u>
<h3><p>- Sofa and Sofa Sets <br>
 - Seating<br>
 - Chairs<br>
 - Tables<br>
 </p></h3>
...
<?php 
  ...
  $sql="Select * from furnish where pid BETWEEN 1 AND 15";
 ...
 if (mysqli_num_rows($result) > 0) {
	...
	echo ("<div class='w3-quarter' style='margin-top:45px; margin-bottom:25px;'><div class='w3-card-2 w3-white'><center><img height='213' width='100' src=".$row["image"]." alt='Vernazza' style='width:85%;height:100%'></center><div class='w3-container'><h3>".$row["name"]."</h3><p>Price: ₹ ".$row["price"]."</p><p>Shipping included.</p> <p> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp   <a href='addtocart.php?id=".$row["pid"]."' class='input' >Add to Cart</a></p></div></div></div>");
	}
 }
 else{
