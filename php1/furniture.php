...
&nbsp&nbsp&nbsp <u><h1>Fruits</h1></u>
<h2><p>- Fruit baskets. <br>
 - Cut fresh fruits.<br>
 - Sold by units.<br>
 - Sealed packaging.<br>
 </p></h2>
...
<?php 
  ...
  $sql="Select * from fruits where pid BETWEEN 1 AND 7";
 ...
 if (mysqli_num_rows($result) > 0) {
	...
	echo "<div class='w3-quarter' style='margin-top:45px; margin-bottom:25px;'>
					<div class='w3-card-2 w3-white'><center><img height='213' width='120' src='".$row["image"]."' alt='Vernazza' style='width:85%'></center>
