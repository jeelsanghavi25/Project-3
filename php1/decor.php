...
&nbsp&nbsp&nbsp <u><h1>Decor</h1></u>
<h3><p>- Carpets <br>
 - Wind Chimes<br>
 - Cushions<br>
...
<?php 
  ...
  $sql="Select * from furnish where pid BETWEEN 49 AND 63";
 ...
 if (mysqli_num_rows($result) > 0) {
	...
	echo ("<div class='w3-quarter' style='margin-top:45px; margin-bottom:25px;'><div class='w3-card-2 w3-white'><center><img height='213' width='120' src=".$row["image"]." alt='Vernazza' style='width:70%'></center><div class='w3-container'><h3>".$row["name"]."</h3><p>Price: ₹ ".$row["price"]."</p><p>Shipping included.</p> <p> &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp &nbsp  &nbsp &nbsp  <a href='addtocart.php?id=".$row["pid"]."' class='input' >Add to Cart</a> </p></div></div></div>");
	}
 }
 else{
