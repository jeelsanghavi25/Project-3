...
</div><div class="w3-row-padding w3-padding-64 w3-theme-l1" id="work">

<div class="w3-quarter">
&nbsp&nbsp&nbsp <u><h1>Dairy Products</h1></u>
...
<?php 
  ...
  $sql="Select * from fruits where pid BETWEEN 15 AND 21";
